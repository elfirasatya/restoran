    ...
    <div class="row-fluid">
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      if(isset($_REQUEST['tambah_pesan'])){
                        ...
                        $query_tambah_pesan = "INSERT INTO tb_pesan (id_user,id_masakan,id_order,jumlah,status_pesan) VALUES(".(int)$id.", ".(int)$id_masakan.", NULL, 1,'')";
			$sql_tambah_pesan= $conn->query($query_tambah_pesan);
                        ...
                        $sql_olah_stok= $conn->query($query_olah_stok);

                        var_dump($sql_tambah_pesan);
                        if($sql_tambah_pesan){
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "INSERT INTO tb_order (id_admin,id_pengunjung, waktu_pesan, no_meja, total_harga,uang_bayar, uang_kembali,status_order ) VALUES(".(int)$id_admin .", ".(int)$id_pengunjung.", '$time', ".(int)$no_meja.", '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order')";
            $sql_simpan_order = $conn->query($query_simpan_order);
