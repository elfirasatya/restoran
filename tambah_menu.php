        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="control-group">
                <div class="controls">
                  <input class="span11" value="" name="gambar" type="file"  onchange="preview(this,'previewne')"/>
                </div>
              </div>
            </div>
            <div class="control-group">
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "INSERT INTO tb_masakan (nama_masakan, harga, stok, status_masakan, gambar_masakan) VALUES ('$nama_masakan', '$harga','$stok','$status_masakan','$gambar')";
              $sql_tambah_masakan= $conn->query($query_tambah_masakan);
            ...
            if(isset($_POST['ubah_menu'])){
              ...
              if($gbr != "" || $gbr != null){
                ...
                $query_ubah_gambar = "update tb_masakan set gambar_masakan = '$gambar' where id_masakan =". (int) $id_masakan;;
